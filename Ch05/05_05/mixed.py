...
# isinstance to determine whether the input is what ?
# and there is diff print function for all the values
# everything is obj and allows to create any structured data
